...
//               : ""
//           }
//           <td style="padding: 8px; text-align: left;">${lead.campaignName} (${
//             lead.campaignId
//           })</td>
...
//   // Updated detailedLeadsTable with status coloring
...
//           <td style="padding: 8px; text-align: left;" class="${statusClass}">${lead.status}</td>
//           <td style="padding: 8px; text-align: left;">${formatDealSize(lead.oppValue)}</td>
//         </tr>`
//       }
//     )
//     .join("");
...
//       }
//       .warm {
//         background-color: #ffbf00 !important; /* Using a hex code for amber */
//         color: black;
//       }
//       .hot {
...
//       /* Alternatively, you can make the selectors more specific to increase their priority */
//       table tr.cold {
    ...
    .map(([date, leads]) =>
      leads
        ...
        <tr>
          ...
          <td style="padding: 12px; text-align: left;">${lead.leadName}</td>
